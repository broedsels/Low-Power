...
* ========  ===========
* 1.70      Added support for ATtiny85. Should work for ATtiny25/45 too. (rg)
*			Tested with IDE 1.8.1
										 ...
										 timer2_t timer2)
{
	...
	#if !defined(__AVR_ATmega32U4__)  && !defined(_ATTINY85_POWER_SCHEME) && !defined(_ATTINY84_POWER_SCHEME)
	if (timer2 == TIMER2_OFF)
	{
		if (TCCR2B & CS22) clockSource |= (1 << CS22);
		if (TCCR2B & CS21) clockSource |= (1 << CS21);
							     ...
							     timer2_t timer2)
{
	...
	#if !defined(__AVR_ATmega32U4__) && !defined(_ATTINY84_POWER_SCHEME)
	if (timer2 == TIMER2_OFF)
	{
		if (TCCR2B & CS22) clockSource |= (1 << CS22);
		if (TCCR2B & CS21) clockSource |= (1 << CS21);
...
#if !defined(_ATTINY85_POWER_SCHEME) && !defined(_ATTINY84_POWER_SCHEME)
/*******************************************************************************
* Name: powerStandby
